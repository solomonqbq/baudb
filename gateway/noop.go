...
func NoopQuerier() backend.Querier {
	return noopQuerier{}
}

func (noopQuerier) Select(*backend.SelectParams, ...*backendmsg.Matcher) (backend.SeriesSet, error) {
...
func NoopSeriesSet() backend.SeriesSet {
...
func (noopSeriesSet) At() backend.Series {
	return nil
}
...
var emptySeriesSet = noopSeriesSet{}
