...
import (
	...
	"github.com/baudb/baudb/msg/backend"
...
const (
	...
	GatewaySelectRequestType
	GatewaySelectResponseType
...
func Type(m msg.Message) MsgType {
	...
	case *gateway.SelectRequest:
		return GatewaySelectRequestType
	case *gateway.SelectResponse:
		return GatewaySelectResponseType
...
func Get(t MsgType) msg.Message {
	...
	case GatewaySelectRequestType:
		return new(gateway.SelectRequest)
	case GatewaySelectResponseType:
		return new(gateway.SelectResponse)
