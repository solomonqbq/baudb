...
func (q *fanoutQuerier) Select(params *SelectParams, matchers ...*backendmsg.Matcher) (SeriesSet, error) {
...
func (q *mergeQuerier) Select(params *SelectParams, matchers ...*backendmsg.Matcher) (SeriesSet, error) {
	var (
